 ...
 * 3개의 com.kwanwoo.java.Duck 객체를 생성하여 이들을 com.kwawnoo.java.Animal 객체 배열에 저장한다.
 *
 ...
 * com.kwawnoo.java.AnimalSimulator(UpDownCasting) 버전의 46-51 줄의 코드를 아래 코드의 45번째 줄(animal.speak())로 간략화 시킬 수 있다
 */
